...
Выделите память для внутреннего представления поля с помощью `new`. Не забудьте освободить всю память с помощью `delete` в деструкторе и при вызове `NewGame`.
